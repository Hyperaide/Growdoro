...
const GOOGLE_CLIENT_NAME = process.env.NEXT_PUBLIC_GOOGLE_CLIENT_NAME || 'growdoro';
...
export default function AuthContextProvider({ children }: { children: React.ReactNode }) {
    if (!GOOGLE_CLIENT_ID) {
        console.warn('⚠️ NEXT_PUBLIC_GOOGLE_CLIENT_ID not set in environment variables');

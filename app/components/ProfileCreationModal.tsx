...
export default function ProfileCreationModal({ isOpen, onClose, userId }: ProfileCreationModalProps) {
    ...
    const getUsernameIcon = () => {
        if (isCheckingUsername) {
            return <CircleNotchIcon size={20} className="text-gray-400 animate-spin" />;
        }
        
        if (isUsernameAvailable === true) {
            return <CheckCircleIcon size={20} weight="fill" className="text-green-500" />;
        }
                    ...
                    {step === 1 && (
                        ...
                        >
                            ...
                            <p className="text-gray-600 mb-6 text-sm">
                                Choose a unique username to get started with Growdoro. This will also be your link for sharing your garden.
                            </p>
                            ...
                            <form onSubmit={handleUsernameSubmit}>
                                ...
                                <button
                                    type="submit"
                                    disabled={isCreating || isCheckingUsername || isUsernameAvailable === false || (username.length >= 3 && isUsernameAvailable === null)}
                        ...
                        >
                            ...
                            <div className="mt-8 flex gap-3">
                                ...
                                <a
                                    ...
                                    onClick={(e) => {
                                        e.preventDefault();
                                        window.open(`${process.env.NEXT_PUBLIC_STRIPE_PAYMENT_LINK}?client_reference_id=${profileId}`, '_blank');
                                    }}
                                ...
                                >
                                    <SealCheckIcon size={16} weight="fill" className="text-white" />
                                    Become a Supporter
                                </a>
                            </div>
                        </motion.div>
